    ...
    return (
        <footer className='footer'>
            <div className='footer_content'>
                <h4 className='footer_title'>HenryMusic</h4>
                <ul className='socials'>
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100089871790200" target="_blank" className='socials_link'>
                    ...
                    <li>
                        <a href="https://www.youtube.com/@henrymusic9010" target="_blank" className="socials_link">
                    ...
                    <li>
                        <a href="https://github.com/juanxp1/henryMusic" target="_blank" className="socials_link">
